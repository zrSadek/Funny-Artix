    ...
    async execute(client, message, args) {
        ...
        if (owner.get(`owners.${message.author.id}.${message.guild.id}`) || message.guild.ownerId === message.author.id || config.app.funny.includes(message.author.id) === true) {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setDescription(`[• Antilink ${al}](${config.app.support})\n[• Antiban ${ab}](${config.app.support})\n[• AntiChannel ${ac}](${config.app.support})\n[• Antieveryone ${ae}](${config.app.support})\n[• Antirole ${ar}](${config.app.support})\n[• Antibot ${abo}](${config.app.support})\n[• AntiWebhook ${aw}](${config.app.support})`)
